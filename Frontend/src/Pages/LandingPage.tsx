...
export default function LandingPage() {
	...
	return (
		...
		<>
			<Header />
			<div className="relative flex h-screen content-center items-center justify-center pt-16 pb-32 rounded-xl">
					...
					<div className="flex flex-wrap items-center">
						<div className="ml-auto mr-auto w-full px-4 text-center lg:w-8/12">
							<Typography
								...
								Split bills with your friends without any hassle
							</Typography>
							<Typography
								variant="lead"
								color="white"
								className="opacity-80">
								Split bills with your friends easily and
								efficiently. Register today with your friends
							</Typography>
							<div className="sm:max-w-10 mx-auto mt-10 max-w-sm sm:flex sm:justify-center">
								<Link to="/signup" className="w-full">
			...
			<section className="-mt-32 bg-gray-50 px-4 pb-20 pt-4">
				<div className="container mx-auto">
					<div className="relative bg-gradient-to-r from-blue-800 to-pink-700 rounded-xl">
						<div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:px-8 lg:pt-24">
							<h2 className="text-3xl font-extrabold tracking-tight text-white">
								Our Features
							</h2>
							<p className="mt-4 max-w-3xl text-lg text-gray-200">
								FinSplit has lots of features. Explore the
								features below to know what you are missing out
								on.
							</p>
							<div className="mt-12 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16">
								{features.map((feature) => (
						...
						<div className="mx-auto -mt-8 w-full px-4 md:w-5/12">
							...
							<Typography className="mb-8 font-normal text-blue-gray-500">
								<p className="mt-4 text-lg text-gray-500">
									...
									to keep track of your bills and share your
									expenses with your friends.
								</p>
							</Typography>

							<Link to="/signup">
								<Button className="m-0">Get Started</Button>
							</Link>
						</div>
						<div className="mx-auto mt-24 flex w-full  justify-center px-4  right-0 lg:mt-0">
							<Card className="shadow-lg shadow-gray-500/10 rounded-xl right-0 shadow-xl">
								<img
									alt="Card"
									src={img}
									className="h-full w-94  rounded-xl shadow-xl right-0"
								/>
							</Card>
						</div>
					</div>
							...
							<div className="mx-auto max-w-xl px-4 sm:px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0">
								<div>
									...
									<div className="mt-6">
										...
										<p className="mt-4 text-lg text-gray-500">
											Want to share your expenses with
											group of friends? No worries create
											groups and share it easily.
										</p>
										<div className="mt-6">
											<Button>Get Started</Button>
										</div>
