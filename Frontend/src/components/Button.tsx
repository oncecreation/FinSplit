...
const ButtonTypeStyle: StyleType = {
  primary:
    "cursor-pointer px-4 py-2 md:px-6 rounded font-medium active:ring-2 ring-brand-200 text-white bg-blue-600 hover:bg-brand-700",
  secondary:
  ...
  danger:
    "cursor-pointer px-4 py-2 md:px-6 rounded font-medium active:ring-2 ring-pink-200 text-white bg-pink-600 hover:bg-pink-700",
  secondaryDanger:
  ...
  icon: "p-2  border border-red-600 ring-zinc-200 duration-150 ease-in-out rounded-full text-xl hover:bg-red-100",
  loading:
