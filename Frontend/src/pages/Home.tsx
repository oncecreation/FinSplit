...
const Home = () => {
  ...
  return (
    <div className="my-10 pb-10 bg-gray-100 flex-1 px-4 sm:px-6 lg:mx-auto lg:px-8 xl:max-w-6xl">
      {/* Group Overview */}
      <div className="my-12">
        <CardHeader variant="gradient" color="blue" className={`flex border-b p-6 mb-10 ${groupList.length>3?"justify-between":"justify-center"} `}>
        ...
        {groupList ? (
          ...
          <div className="mt-6 grid w-full space-y-3 sm:place-content-center sm:place-items-center sm:space-y-0 md:grid-cols-2 lg:grid-cols-3">
                 ...
                 <StatisticsCard
                    ...
                    footer={
                      <Typography className="font-normal flex flex-col text-blue-gray-600">
                        <strong className={'text-green-500'}> Total Expenses :{group.totalExpenses}</strong>
            ...
            {groupList.length < 3 && (
              <>
                <Link to="/addgroup" className="h-56 rounded-xl shadow-sm sm:w-3/4">
      ...
      <div className="mt-12 mb-10 shadow-md rounded-xl bg-white ">
        <CardHeader variant="gradient" color="blue" className="flex justify-center border-b p-3">
